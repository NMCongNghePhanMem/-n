...
namespace QuanLyKhachSan
{
    public partial class FormThayDoiQuyDinh : Form
    {
        ...
        BusinessLogicTier.LoaiKhachBUS loaiKhach;
        ...
        {
            if (isThamSoChanged == true || isLoaiPhongChanged == true || isLoaiKhachChanged == true)
            {
        ...
        {
            if ((e.KeyChar >= 'a' && e.KeyChar <= 'z') || e.KeyChar == '\b' || (e.KeyChar >= '0' && e.KeyChar <= '9'))
            {
                return;
            }
            else
